						...
						<table class="table table-bordered table-striped fs13">
							...
							<tbody>
								<c:forEach items="${cartList}" var="cartItem">
									<tr>
										<td class="span1"><img
											src="<c:url value='/resources/images/product images/${cartItem.products.id}.jpg'/>"
										...
										<a
											href="<c:url value="/usercart/cart/addQty/${cartItem.products.id}/${cartId}"/>"
											class="btn btn-primary center">
										</a>&nbsp;&nbsp;&nbsp;
										<a
											href="<c:url value="/usercart/cart/reduceQty/${cartItem.products.id}/${cartId}"/>"
											class="btn btn-danger btnAction">-
										</a>
										</td>
										<td>${cartItem.totalPrice}</td>
										<td><a
											href="<c:url value="/usercart/cart/removeItem/${cartItem.products.id}/${cartId}"/>"
